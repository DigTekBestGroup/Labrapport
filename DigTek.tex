...
\section{Resultater}
Gruppen fikk ferdigstillt og testet (Tabell \ref{tbl:probabilitetsdistribusjon}) to terningkretser. Den 3. terningen ble ikke ferdig.
...
\begin{table}[H]
    ...
    6 & 11 \\ \hline
    \end{tabular}
    \caption{Probabilitetsdistribusjon}
